...
const PeaceAndMisanGallery = (props) => {
  const images = importAll(require.context('./peaceandmisan', false, /\.(png|jpe?g|svg)$/));
  ...
  return (
    <div className="py-12">
      <div className="mx-auto px-4 sm:px-16 lg:px-16">
        <h2 className="text-4xl  text-gray-900 mb-8 text-center font-light ">Peace & Misan's Church Wedding Gallery</h2>
        <div className="flex justify-center gap-8 items-start flex-wrap">
          <div className='max-sm:w-5/5 w-96 flex flex-col gap-y-8 overflow-hidden '>
...
export default PeaceAndMisanGallery;
